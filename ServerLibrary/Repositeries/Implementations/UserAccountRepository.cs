...
using ServerLibrary.Repositeries.Contracts;
...
namespace ServerLibrary.Repositeries.Implementations
{
    public class UserAccountRepository(IOptions<JwtSection> config, AppDbContext appDbContext) : IUserAccount
    {
        ...
        public async Task<LoginResponse> SignInAsync(Login user)
        {
            ...
            //Save the refresh token to the databse
        ...
        public async Task<LoginResponse> RefreshTokenAsync(RefreshToken token)
        {
            ...
            if (user is null) return new LoginResponse(false, "Refresh token could not be generated becuase user not found");
            ...
            if (updateRefreshToken is null) return new LoginResponse(false, "Refrsh token could not be generated because user has not signed in");
